# ============================================================
# normalise.R minor adaptions from Ilangovan et al. for replication
# ============================================================
...
glds168_rr1_dds <- function(counts_fname, metadata_fname) {
  ...
  write.csv(rr1_counts, file='168_RR1.csv')
...
glds168_rr3_dds <- function(counts_fname, metadata_fname) {
  ...
  write.csv(rr3_counts, file='168_RR3.csv')
