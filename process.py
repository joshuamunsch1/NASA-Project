...
plt.tight_layout()
plt.savefig("pca_before_after_harmonisation.png", dpi=300, bbox_inches='tight')
plt.show()

print("Saved PCA coords (before/after) and figure: pca_before_coords.csv, pca_after_coords.csv, pca_before_after_harmonisation.png")
